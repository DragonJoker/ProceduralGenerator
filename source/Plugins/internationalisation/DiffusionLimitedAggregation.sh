...
CPP_FILE_LIST=`find ../source/DiffusionLimitedAggregation -name '*.cpp' -print`
xgettext -d DiffusionLimitedAggregation -s --keyword=_ -p ../po -o DiffusionLimitedAggregation.pot $CPP_FILE_LIST
