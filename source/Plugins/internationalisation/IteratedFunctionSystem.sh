...
CPP_FILE_LIST=`find ../source/IteratedFunctionSystem -name '*.cpp' -print`
xgettext -d IteratedFunctionSystem -s --keyword=_ -p ../po -o IteratedFunctionSystem.pot $CPP_FILE_LIST
