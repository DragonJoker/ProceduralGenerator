...
*/
#ifndef ___IFX_LAPLACIAN_OF_GAUSSIAN_FUNCTOR_H___
#define ___IFX_LAPLACIAN_OF_GAUSSIAN_FUNCTOR_H___

#include "EffectFunctor.h"

namespace ImageEffects
{
	class LaplacianOfGaussianFunctor
		: public EffectFunctor
	{
	public:
		LaplacianOfGaussianFunctor();
		virtual ~LaplacianOfGaussianFunctor();
