...
namespace PerlinNoise
{
	...
	void Generator::DoGeneratePanel()
	{
		...
		m_staticOctaves = std::make_shared< StaticCtrl >( m_options, _( "Octaves: " ), Position( 10, 10 + DEFAULT_HEIGHT * 3 ), Size( CONFIG_PANEL_WIDTH -  20, DEFAULT_HEIGHT ), eSTATIC_STYLE_VALIGN_CENTER );
		m_staticFrequency = std::make_shared< StaticCtrl >( m_options, _( "Frequency: " ), Position( 10, 10 + DEFAULT_HEIGHT * 5 ), Size( CONFIG_PANEL_WIDTH -  20, DEFAULT_HEIGHT ), eSTATIC_STYLE_VALIGN_CENTER );
		m_comboFunction = std::make_shared< ComboBoxCtrl >( m_options, l_arrayFuncNames, 0, eID_FUNCTION, Position( 10, 10 + DEFAULT_HEIGHT * 12 ), Size( CONFIG_PANEL_WIDTH -  20, DEFAULT_HEIGHT ), 0, false );
		m_comboFunction->Connect( eCOMBOBOX_EVENT_SELECTED, std::bind( &Generator::DoSetFunction, this, std::placeholders::_1 ) );

		std::shared_ptr< SliderCtrl > l_red = std::make_shared< SliderCtrl >( m_options, Range( 0, 255 ), 255, eID_REDVALUE, Position( 30, 10 + DEFAULT_HEIGHT * 0 ), Size( CONFIG_PANEL_WIDTH -  40, DEFAULT_HEIGHT ) );
		...
		std::shared_ptr< SliderCtrl > l_green = std::make_shared< SliderCtrl >( m_options, Range( 0, 255 ), 255, eID_GREENVALUE, Position( 30, 10 + DEFAULT_HEIGHT * 1 ), Size( CONFIG_PANEL_WIDTH -  40, DEFAULT_HEIGHT ) );
		...
		std::shared_ptr< SliderCtrl > l_blue = std::make_shared< SliderCtrl >( m_options, Range( 0, 255 ), 255, eID_BLUEVALUE, Position( 30, 10 + DEFAULT_HEIGHT * 2 ), Size( CONFIG_PANEL_WIDTH -  40, DEFAULT_HEIGHT ) );
		...
		std::shared_ptr< SliderCtrl > l_octaves = std::make_shared< SliderCtrl >( m_options, Range( 2, 100 ), 2, eID_OCTAVES, Position( 10, 10 + DEFAULT_HEIGHT * 4 ), Size( CONFIG_PANEL_WIDTH -  20, DEFAULT_HEIGHT ) );
		...
		std::shared_ptr< SliderCtrl > l_frequency = std::make_shared< SliderCtrl >( m_options, Range( 2, 1000 ), 50, eID_FREQUENCY, Position( 10, 10 + DEFAULT_HEIGHT * 6 ), Size( CONFIG_PANEL_WIDTH -  20, DEFAULT_HEIGHT ) );
		...
		std::shared_ptr< ListBoxCtrl > l_types = std::make_shared< ListBoxCtrl >( m_options, l_arrayTypeNames, 0, eID_TYPE, Position( 10, 10 + DEFAULT_HEIGHT * 8 ), Size( CONFIG_PANEL_WIDTH -  20, DEFAULT_HEIGHT * 3 ) );
		l_types->Connect( eLISTBOX_EVENT_SELECTED, std::bind( &Generator::DoSetType, this, std::placeholders::_1 ) );

		m_arrayControls.push_back( std::make_shared< StaticCtrl >( m_options, _( "R" ), Position( 10, 10 + DEFAULT_HEIGHT * 0 ), Size( 20, DEFAULT_HEIGHT ) ) );
		m_arrayControls.push_back( l_red );
		m_arrayControls.push_back( std::make_shared< StaticCtrl >( m_options, _( "G" ), Position( 10, 10 + DEFAULT_HEIGHT * 1 ), Size( 20, DEFAULT_HEIGHT ) ) );
		m_arrayControls.push_back( l_green );
		m_arrayControls.push_back( std::make_shared< StaticCtrl >( m_options, _( "B" ), Position( 10, 10 + DEFAULT_HEIGHT * 2 ), Size( 20, DEFAULT_HEIGHT ) ) );
		m_arrayControls.push_back( l_blue );
		m_arrayControls.push_back( m_staticOctaves );
		m_arrayControls.push_back( std::make_shared< StaticCtrl >( m_options, _T( "2" ), Position( 90, 10 + DEFAULT_HEIGHT * 3 ), Size( CONFIG_PANEL_WIDTH - 100, DEFAULT_HEIGHT ), eSTATIC_STYLE_VALIGN_CENTER ) );
		m_arrayControls.push_back( l_octaves );
		m_arrayControls.push_back( m_staticFrequency );
		m_arrayControls.push_back( std::make_shared< StaticCtrl >( m_options, _T( "50" ), Position( 90, 10 + DEFAULT_HEIGHT * 5 ), Size( CONFIG_PANEL_WIDTH - 100, DEFAULT_HEIGHT ), eSTATIC_STYLE_VALIGN_CENTER ) );
		m_arrayControls.push_back( l_frequency );
		m_arrayControls.push_back( std::make_shared< StaticCtrl >( m_options, _( "Type : " ), Position( 10, 10 + DEFAULT_HEIGHT * 7 ), Size( CONFIG_PANEL_WIDTH -  20, DEFAULT_HEIGHT ), eSTATIC_STYLE_VALIGN_CENTER ) );
