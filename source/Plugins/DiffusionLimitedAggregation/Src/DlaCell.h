...
namespace ProceduralTextures
{
	struct DlaCell
	{
		...
		DlaCell();
		DlaCell( const DlaCell & cell );
		~DlaCell();

		DlaCell & operator =( const DlaCell & cell );

		void Set( UbPixel * p_pixel, bool p_white );
...
namespace ProceduralTextures
{
	template <> class Policy< ProceduralTextures::DlaCell >
	{
	private:
		typedef ProceduralTextures::DlaCell value_type;
