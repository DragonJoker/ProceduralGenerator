...
{
	LevyDragon::LevyDragon( std::shared_ptr< PixelBuffer > p_pBackBuffer, int p_iWidth, int p_iHeight )
		:	IfsGenerator( p_pBackBuffer, p_iWidth, p_iHeight, 160, 4, 160, Point2d( 0.5, 0.0 ), 2 )
	{
		DoInitialiseVariations();
	}

	void LevyDragon::DoInitialiseVariations()
	{
		// x = a[0]*x + a[1]*y + a[2]
		// y = b[0]*x + b[1]*y + b[2]
		...
		m_arrayVariations[2]	= Point3d( 0.500,  0.500,  0.500 );
		m_arrayVariations[3]	= Point3d( -0.500,  0.500,  0.500 );
