// 'Valleyball' by Bluflame (2009)
// Based on a production from the demoscene, Valleyball, 
// a 4k intro by Bluflame (http://www.pouet.net/prod.php?which=52946), 
// which made fourth position in the Breakpoint 2009 demoparty in Germany.
...
void main()
{
    ...
    Y.z = 1.0;
    Y.w = resolution.x / resolution.y;//1.333;
