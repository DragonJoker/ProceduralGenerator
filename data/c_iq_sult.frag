...
// Based on a production from the demoscene, Sult, 
// a 4k intro by Loonies (http://www.pouet.net/prod.php?which=52940), 
// which made third position in the Breakpoint 2009 demoparty in Germany.
...
void main(void)
{
	resolution = vec2( pg_width, pg_height );
	time = pg_time / 1000.0;
