// 'Quaternion' by iq (2009)
// Raymarching a quaternionic Julia set with distance fields
// (using the Distance Estimator based in the Hubbard-Douady potential theory)
